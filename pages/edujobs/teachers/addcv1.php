...
if (check_if_user_is_teacher($user) && $user->guid==$uguid) { 
    ...
    $title = elgg_echo('edujobs:cv:add1');
    ...
    $content = elgg_view_form('edujobs/cvs/addcv1', $form_vars, $vars);

    $body = elgg_view_layout('content', array(
        'content' => $content,
        'title' => $title,
        'sidebar' => elgg_view('edujobs/cv_sidebar', array('user_guid' => $uguid, 'selected' => 'cv1')),
        'filter' => '',
    ));
